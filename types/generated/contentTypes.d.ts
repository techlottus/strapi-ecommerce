...
export interface ApiTrackInscriptionTrackInscription
  extends Schema.CollectionType {
  collectionName: 'track_inscriptions';
  info: {
    singularName: 'track-inscription';
    pluralName: 'track-inscriptions';
    displayName: 'track inscription';
    description: '';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<
      'api::track-inscription.track-inscription',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiTrackInvoiceTrackInvoice extends Schema.CollectionType {
  collectionName: 'track_invoices';
  info: {
    singularName: 'track-invoice';
    pluralName: 'track-invoices';
    displayName: 'track invoice';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    tax_person: Attribute.String;
    RFC: Attribute.String;
    CFDI_use: Attribute.String;
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::track-invoice.track-invoice',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiTrackPaymentTrackPayment extends Schema.CollectionType {
  collectionName: 'track_payments';
  info: {
    singularName: 'track-payment';
    pluralName: 'track-payments';
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::track-payment.track-payment',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiTrackSubscriptionTrackSubscription
  extends Schema.CollectionType {
  collectionName: 'track_subscriptions';
  info: {
    singularName: 'track-subscription';
    pluralName: 'track-subscriptions';
    displayName: 'track subscription';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::track-subscription.track-subscription',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::track-inscription.track-inscription': ApiTrackInscriptionTrackInscription;
      'api::track-invoice.track-invoice': ApiTrackInvoiceTrackInvoice;
      'api::track-payment.track-payment': ApiTrackPaymentTrackPayment;
      'api::track-subscription.track-subscription': ApiTrackSubscriptionTrackSubscription;
    }
  }
}
